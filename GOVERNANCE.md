# GitLab-Controller Governance

This document defines governance policies for the GitLab-Controller project.

## Roles

GitLab-Controller uses a two-tiered system of maintainer roles:

* Senior Maintainers
  * Have the most experience with the GitLab-Controller project and are expected to have the knowledge and insight to lead the project's growth and improvement
  * Represent their organization within the GitLab-Controller community
...
* Standard Maintainers
  * Have less experience with the GitLab-Controller project than senior maintainers, but are also expected to provide significant value to the project, helping it grow and improve
...
* Express interest to the [senior maintainers](OWNERS.md#senior-maintainers) directly that your
  ...
  you are going to be spending substantial time (>25%) on GitLab-Controller for the foreseeable future. You
...
* During GitHub issue triage, apply all applicable [labels](https://github.com/crossplaneio/gitlab-controller/labels)
...
* In general continue to be willing to spend at least 25% of ones time working on GitLab-Controller (~1.25
...
Maintainers will be added to the GitLab-Controller GitHub organization (if they are not already) and added to
